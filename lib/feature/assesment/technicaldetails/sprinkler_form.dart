...
final List<FormMapper> sprinklerFormMapper = [
  FormMapper(
  ...
  FormMapper(
    formName: "groundwater_potential",
    formType: "Dropdown",
    label: "Whether the ground water potential is adequate to go in for exploitation",
    options: ["Safe", "Semi Critical", "Critical", "Over Exploited"],
  ),
  FormMapper(
