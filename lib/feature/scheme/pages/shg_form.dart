...
class ShgForm extends StatelessWidget {
  final String title;
  // scrollcontroller is required to scroll to errorformfield
  final _scrollController = ScrollController();
  ShgForm({required this.title, super.key});

  final FormGroup form = AppForms.SHG_DETAILS_FORM();
                  ...
                  child: Column(
                    children: [
                      ...
                      SearchableDropdown<Lov>(
                        fieldKey: _genderKey,
                        controlName: 'gender',
                        label: 'Whether classified as special SHG',
                        items:
                            state.lovList!
