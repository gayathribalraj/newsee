...
// class OtherPersonal extends StatefulWidget {
//   final String title;
//   // scrollcontroller is required to scroll to errorformfield

//   OtherPersonal({required this.title, super.key});

//   @override
//   State<OtherPersonal> createState() => _OtherPersonalState();
// }

// class _OtherPersonalState extends State<OtherPersonal> {
...
//           .updateValue(formatAmount(val['loanAmountRequested']));
...
//                                 PersonalData
//                                 personalDataFormatted = personalData.copyWith(
