...
class RegistrationScreen extends StatefulWidget {
  ...
  const RegistrationScreen({super.key,this.onRegistrationSuccess});
...
class _RegistrationPageState extends State<RegistrationScreen> {
  ...
  doFaceDetection() async {
    ...
    var ocrresult = extractDLInfo(extractedText);
    ...
    for (Face face in faces) {
      ...
      showFaceRegistrationDialogue(Uint8List.fromList(img.encodeBmp(croppedFace)), recognition,ocrresult);
